...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_unified_inbox,
            commands::search_emails_global,
            commands::filter_search_results,
            commands::get_search_history,
            commands::clear_search_history,
            commands::get_smart_inbox_summary,
            commands::set_smart_inbox_override,
            commands::list_smart_inbox_groups,
